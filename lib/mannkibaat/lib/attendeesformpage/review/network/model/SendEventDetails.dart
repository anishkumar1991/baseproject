...
//
//     final sendEventDetailsModel = sendEventDetailsModelFromJson(jsonString);

import 'dart:convert';

SendEventDetailsModel sendEventDetailsModelFromJson(String str) => SendEventDetailsModel.fromJson(json.decode(str));

String sendEventDetailsModelToJson(SendEventDetailsModel data) => json.encode(data.toJson());

class SendEventDetailsModel {
  SendEventDetailsModel({
  ...
  factory SendEventDetailsModel.fromJson(Map<String, dynamic> json) => SendEventDetailsModel(
    status: json["status"],
