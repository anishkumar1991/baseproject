      ...
      children: [
                ...
                validator: (dynamic value) {
                  if (cubit.entryField![i].mandatoryField ?? false) {
                    if (value == null) {
                      return '${S
                          .of(context)
                          .please} ${cubit.entryField![i].displayNameForUI ??
                          ""} ${S
                          .of(context)
                          .enter}';
                    }
        ...
        /// Here text field  generate logic
                          ...
                          TextFieldWidget(
                              ...
                              keyboardType: cubit.getTextInputType(
                                  fieldType: cubit.entryField![i].fieldName ??
                                      ''),
                              hintText: 'Enter Your ${cubit.entryField![i]
                                  .displayNameForUI}'),
                          spaceHeightWidget(8),
                          UploadCard(
                            uploadedFilePath: FieldHandler
                                .getFileName(
                                "${(cubit.entryField![i].fieldName ?? "").split(
                                    RegExp(r"[A-Z]"))[0]}_url",
                                cubit)
                                .split("/")
                                .last,
                        ...
                        onTapImagePrivew: (() {
                          ...
                          showDialog(
                              ...
                              builder: ((context) =>
                                  ImagePreViewDialog(
                                      path: cubit
                                          .allImagePickerList[index]["value"])));
                        }),
                        onTap: (() async {
                          // await cubit.pickFile(
                          //     "${(cubit.entryField![i].fieldName ?? "").split(RegExp(r"[A-Z]"))[0]}_url");
                    ...
                    if (cubit.entryField![i].fieldName == "pannaNumber") ...[
                      ...
                      ...[
                        TextFieldWidget(
                            ...
                            isMandatoryField:
                            cubit.entryField![i].mandatoryField ?? false,
                            textInputFormatter: DynamicValidator
                                .addTextInputFormatters(
                                fieldType: cubit.entryField![i].fieldName ??
                                    ''),
                            onChanged: (value) {
                              FieldHandler.onUpdate(i, value,
          ...
          /// Here radio button
            ...
            if (DynamicUIHandler.radioButton
                .contains(cubit.entryField![i].fieldName)) ...[
              spaceHeightWidget(20),
              BlocBuilder<AddEntryCubit, AddEntryState>(
                builder: (context, state) {
            ...
            /// Here calender view
              ...
              if (DynamicUIHandler.calenderView
                  .contains(cubit.entryField![i].fieldName)) ...[
                spaceHeightWidget(20),
                ...
                child: BlocConsumer<AddEntryCubit, AddEntryState>(
                  ...
                  builder: (context, state) {
                    if (state is DropDownValueFetchedState) {
                      ...
                      context.read<AddEntryCubit>().getDesignationDropdown(
                          data: {
                            "type": "Designation",
                      ...
                      context
                          .read<AddEntryCubit>()
                          .getDistrictDropdown(
                          widget.countryStateId.toString());
                      ...
                      if (widget.personData != null) {
                        ...
                        cubit.getInitialMultiSelectionFieldData(
                            widget.personData);
