...
class _AddEntryApi implements AddEntryApi {
  _AddEntryApi(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<HttpResponse<dynamic>> getDistrictDropdownData(
    token,
    countryID,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/zila/api/data_entry/party_zilas?state_id=${countryID}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<HttpResponse<dynamic>> getDesignation(
    token,
    data,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> submitAddEntry(
    token,
    data,
  ) async {
    const _extra = <String, dynamic>{};
