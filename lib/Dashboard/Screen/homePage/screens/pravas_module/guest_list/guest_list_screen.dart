                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFieldWidget(
                        onTapDone: (() {
                          cubit.positionFocusNode.unfocus();
                        }),
                        focus: cubit.positionFocusNode,
                        isOtherField: true,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () {
                                                cubit.editGuest(
                                                    attendeesId: cubit.guestList
                                                        .data?[index].iId,
                                                    phone: cubit.guestList
                                                        .data?[index].phone,
                                                    designation: cubit
                                                        .guestList
                                                        .data?[index]
                                                        .designation,
                                                    name: cubit.guestList
                                                        .data?[index].name);
                                              },
                                              child: Container(
                                                decoration: BoxDecoration(
