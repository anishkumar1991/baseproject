                ...
                child: BlocBuilder<PravasCreateCubit, PravasCreateState>(
                  builder: (context, state) {
                    ...
                    return Column(
                      ...
                      children: [
                        TextFieldWidget(
                          focus: cubit.pravasNameFocusNode,
                          isOtherField: true,
                          onTapDone: (() {
                            cubit.pravasNameFocusNode.unfocus();
                          }),
                        ...
                        spaceHeightWidget(5),
                        TextFieldWidget(
                          focus: cubit.subjectFocusNode,
                          isOtherField: true,
                          onTapDone: (() {
                            cubit.subjectFocusNode.unfocus();
                          }),
                        ...
                        CommonButton(
                          onTap: () async {
                            ...
                            if (cubit.prvasNameCtr.text.isEmpty) {
                              EasyLoading.showToast(S.of(context).pravasName,
                              ...
                              EasyLoading.showToast(S.of(context).pravasEndDate,
                                  toastPosition: EasyLoadingToastPosition.top);
                            } else if (cubit.pravasSubjectCtr.text.isEmpty) {
                              EasyLoading.showToast(S.of(context).pravasSubject,
                                  toastPosition: EasyLoadingToastPosition.top);
                            } else {
                ...
                CommonButton(
                  onTap: () {
                    ...
                    Navigator.pushNamed(context, RoutePath.createFunctionScreen,
                        arguments: {'isEdit': false, 'isView': false});
                  },
