...
import 'widget/dependent_dropdown_widget.dart';
import 'widget/filter_options_widget.dart';
import 'widget/main_dropdown_widget.dart';
...
class ZilaDataScreen extends StatefulWidget {
  ZilaDataScreen({super.key, required this.type, this.countryStateId, this.dataLevelId, required this.appPermissions});
...
class _ZilaDataScreenState extends State<ZilaDataScreen> {
  ...
  void initState() {
    ...
    context.read<ZilaDataCubit>().getUserOperationPermission(widget.appPermissions);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    MainDropdownWidget(
                        ...
                        typeLevel: context.read<SangathanDetailsCubit>().typeLevelName ?? "",
                        dataLevelId: widget.dataLevelId ?? 0,
                        countryStateId: widget.countryStateId ?? 0),
                  ],
                ),
                const Divider(
                  thickness: 1.2,
                ...
                /// unit data widget
                DataUnit(type: widget.type ?? "", dataLevelId: widget.dataLevelId ?? 0),
                spaceHeightWidget(20),
                  ...
                  child: BlocBuilder<ZilaDataCubit, ZilaDataState>(
                    builder: (context, state) {
                      ...
                      if (state is PannaKramaankSuccessState) {
                        cubit.pannaKramaankListData = state.pannaKramaankListData.data?.locations ?? [];
                              ...
                              child: cubit.dataList?.isEmpty ?? false
                                  ...
                                  : Column(
                                      children: [
                                        ...
                                        ] else if (cubit.selectedFilterIndex == 1) ...[
              ...
              ? widget.type == 'Panna' && cubit.pannaKramaankListData.isEmpty
                  ...
                  : FloatingActionButton.extended(
                        ...
                        if (widget.type == "Panna") {
                          ...
                          Navigator.pushNamed(context, RoutePath.addEntryScreen,
                              arguments: AddEntryPage(
                                ...
                                countryStateId: widget.type == "Panna" ? pannaCountryStateId : widget.countryStateId,
                                pannaID: cubit.selectedPannaNo?.number,
                                personData: null,
                              ));
                        } else {
                          if (cubit.coreSangathanList?.isEmpty ?? true && cubit.morchaList.isEmpty) {
                      ...
                      label: Text(
                        ...
                        style: GoogleFonts.roboto(fontWeight: FontWeight.w500, fontSize: 14, color: AppColor.white),
                      ))
              : const SizedBox();
        },
      ),
