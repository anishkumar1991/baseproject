...
class ProfileBusinessScreen extends StatefulWidget {
  ...
  const ProfileBusinessScreen({Key? key, required this.cubit})
      : super(key: key);
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, RoutePath.editBusinessScreen,
                      arguments: {
                        "isNew": true,
                        "professionalDetails":
                            widget.cubit.userDetails?.data?.professionalDetails
                      });
                },
                child: Container(
                  height: 35,
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.pushNamed(
                            ...
                            arguments: {
                              "index": 0,
                              "professionalDetails": widget
                                  .cubit.userDetails?.data?.professionalDetails
                            });
                      },
                      child: Padding(
          ...
          widget.cubit.showBusiness
              ? ListView.builder(
                  ...
                  itemCount: widget
                      .cubit.userDetails?.data?.professionalDetails?.length,
                      ...
                      children: [
                        Text(
                          widget.cubit.userDetails?.data
                                  ?.professionalDetails?[index].position ??
                              '',
                          style: textStyleWithPoppin(
                              fontSize: 13,
                              color: AppColor.naturalBlackColor,
                        ...
                        Text(
                          widget.cubit.userDetails?.data
                                  ?.professionalDetails?[index].orgName ??
                              '',
                          style: textStyleWithPoppin(
                              fontSize: 13,
                              color: AppColor.naturalBlackColor,
