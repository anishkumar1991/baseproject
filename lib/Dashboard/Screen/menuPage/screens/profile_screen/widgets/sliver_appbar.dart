                              ...
                              child: cubit.imageFile == null
                                  ? img != ''
                                      ...
                                      : Container(
                                          ...
                                          height: 84,
                                          width: 84,
                                          child: Image.asset(AppIcons.userProfilePlaceholder))
                                  : Image.file(
                                      cubit.imageFile!,
                                      height: 84,
                                      width: 84,
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20), color: AppColor.progressGreenColor),
                              child: Text(
                                "${'${persantage * 100}'.split(".").first}%",
                                textAlign: TextAlign.center,
                                style: GoogleFonts.poppins(
                                    color: AppColor.white, fontSize: 10, fontWeight: FontWeight.w500),
                              ),
                            ),
                          ),
                        )
