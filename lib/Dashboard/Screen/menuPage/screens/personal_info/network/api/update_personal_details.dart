...
abstract class UpdatePersonalDetailsApi {
  ...
  Future<HttpResponse> updatePersonalDetails(@Header('Authorization') String token, @Body() Map<String, dynamic> data);

  @GET('/zila/api/data/caste?category_id={id}&level=1&level_name=14')
